...
Component({
    ...
    methods: {
            ...
            wx.request({
                ...
                success: function (res) {
                    ...
                    if (res.data.code == 0) {
                        ...
                        wx.setStorageSync('purclassList', res.data.data.classList)
        ...
        navigateToLesson: function (event) {
            ...
            wx.navigateTo({
                url: '../purlesson/purlesson?class_id=' + class_id + '&isPurchased=' + this.data.isPurchased + '&price=' + this.data.price
            })
        },
